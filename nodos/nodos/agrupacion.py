...
AGRUPACIONES = ['Complejo de supercúmulos', 'Supercúmulo', 'Cúmulo', 'Grupo', 'Subgrupo']


class ContenidodelNodoAgrupación(ContenidodelNodoAstronómico):
	def contenido(self):
		...
		self.contenido_de_entradas = [
				...
				Desplegable(self, 'Tipo', AGRUPACIONES),
...
@registrar_nodo(NODO_AGRUPACIÓN)
class NodoAgrupación(NodoAstronómico):
	codigo_op = NODO_AGRUPACIÓN
	titulo_op = "Agrupación"

	ClasedelContenidodeNodo = ContenidodelNodoAgrupación
